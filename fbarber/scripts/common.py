...
def get_io_handlers(args: argparse.Namespace
                    ) -> Tuple[FastxFormats, FastXParser, SimpleFastxWriter,
...
def add_unmatched_output_option(arg_group: argparse._ArgumentGroup
...
def add_compress_level_option(arg_group: argparse._ArgumentGroup
                              ) -> argparse._ArgumentGroup:
    arg_group.add_argument(
...
def add_log_file_option(arg_group: argparse._ArgumentGroup
                        ) -> argparse._ArgumentGroup:
    arg_group.add_argument(
        "--log-file", type=str,
